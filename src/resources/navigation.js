...
const slGroup = 'https://world.secondlife.com/group/611e4097-57af-0d49-2fde-07cba646ff66?lang=en'
const patreon = 'https://www.patreon.com/user?u=61556368&fan_landing=true'
...
const headers = [
  ...
  { 
    ...
    dropdowns: [
      { 
        content: 'Combat Classes',
        index: true,
        route: 'classes/combat',
        dropdowns: combatClasses,
      },
      { 
        content: 'Afflicted',
        route: 'afflicted',
  ...
  { 
    ...
    dropdowns: [
      { 
        ...
        route: 'events/monthly',
      },
      { 
        content: 'Faction Events',
        route: 'events/one-time',
      },
    ] 
  },
  { 
  ...
  { 
    ...
    dropdowns: [
      { 
        content: 'Crafting Classes',
        index: true,
        route: 'classes/crafting',
      ...
      },
      {
        ...
        route: 'locations/gathering-nodes'
      }
    ] 
  },
  { 
    ...
    dropdowns: [
      { 
        content: `<svg width="1.5em" height="1.5em" class="align-text-top me-1" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      { 
        content: '<img src="/patreon_logo.png" class="align-text-top me-1" width="24px" height="24px" alt="Patreon Logo" /> Patreon',
        route: patreon,
        newTab: true,
      }
    ] 
