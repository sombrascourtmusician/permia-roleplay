...
const starterQuest = [
  {
    ...
    steps: [
      {
        title: "",
        content: "I haven't seen you around, so that must mean you're new here! Wanna help a girl out for some coin and a bit of an introduction?",
        image: "/permia-carousel1.webp",
      },
      {
        title: "",
        content: "Package? Oh. From the docks. Yes. Right. I'll take that. While you're at it, take this up to the Silver Hold, behind you towards the wooden gate, go straight up to the castle up in the mountains. Can't miss it.",
        image: "/permia-carousel1.webp",
      },
      {
        title: "",
        content: "A frustrated man stands before you, checking some document against the contents of crates of supplies. His eyes brighten as you approach, lingering on your hands.",
        image: "/permia-carousel1.webp",
      },
      {
        title: "",
        content: "A man, a bailiff by his appearance, is monitoring the stockpile of goods behind the gate. He examines a piece of parchment in his hand, looks at you and speaks in a stern tone of voice. '...New here? You should join us, the Royal Sarkadian Guard. We're paid well and keep the rebels from returning us to starving to death in the desert. Give it a thought, yea? Anyways, what's your name?",
        image: "/permia-carousel1.webp",
      },
      {
        title: "",
        content: "Deep in the jungles of Permia, a beast spots you while you're searching. 'Lost little lamb, what brings you to the jungle, hmm? Haven't you heard that they're unsafe?",
        image: "/permia-carousel1.webp",
      },
      {
        title: "",
        content: "The woman seemed impatient after your long journey, staring at you with clear frustration. 'Finally you're back. Did you at least make the delivery?",
        image: "/permia-carousel1.webp",
      },
    ],
  },
